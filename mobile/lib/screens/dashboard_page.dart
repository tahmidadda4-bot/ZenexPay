...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: zenexBackground(context), body: ZenexGlowBackground(safeArea: false, child: RefreshIndicator(color: kCyan, backgroundColor: zenexPanel(context), onRefresh: () async { refresh(); await wallet; }, child: ListView(physics: const AlwaysScrollableScrollPhysics(), padding: const EdgeInsets.fromLTRB(16, 28, 16, 30), children: [
