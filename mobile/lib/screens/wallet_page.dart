    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _Metric('Total earned', '৳ ${zenexMoney(earned)}')),
              Expanded(child: _Metric('Withdrawn', '৳ ${zenexMoney(withdrawn)}')),
...
class _TransactionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: Text(title, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w800)),
      subtitle: Text(_date(row['created_at']), style: const TextStyle(color: Colors.white54, fontSize: 11)),
      trailing: Text(
