...
class _BalanceCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final balanceText = '৳ ${zenexMoney(balance)}';
    final earnedText = '৳ ${zenexMoney(earned)}';
    final withdrawnText = '৳ ${zenexMoney(withdrawn)}';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFF174EA6), Color(0xFF4F35C8), Color(0xFF8B32F5)],
        ),
        borderRadius: BorderRadius.circular(26),
        border: Border.all(color: Colors.white.withOpacity(.12)),
        boxShadow: [
          BoxShadow(
            color: kPurple.withOpacity(.24),
            blurRadius: 28,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Total earned  $earnedText',
            style: const TextStyle(color: Colors.white70, fontSize: 12),
          ),
          const SizedBox(height: 18),
          Row(
            children: [
              Expanded(child: _Metric('Available', balanceText)),
              Container(width: 1, height: 36, color: Colors.white24),
              Expanded(child: _Metric('Total earned', earnedText)),
            ],
          ),
          const SizedBox(height: 10),
          Row(
