...
class _WalletPageState extends State<WalletPage> {
  ...
  Future<void> withdraw() async {
    ...
    try {
      ...
      amount.clear();
      account.clear();
      setState(() => future = SupabaseService.wallet());
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async => setState(() => future = SupabaseService.wallet()),
        child: ListView(
          ...
          children: [
            FutureBuilder<Map<String, dynamic>?>(
              ...
              builder: (_, s) {
                ...
                final w = s.data?['total_withdrawn'] ?? 0;
                return Card(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Expanded(child: Text('Earned ৳ ${_money(e)}')),
                            Expanded(child: Text('Withdrawn ৳ ${_money(w)}')),
                          ],
                        ),
                      ],
                    ),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: FilledButton(
                        ...
                        child: Text(busy ? 'Processing...' : 'Request withdrawal'),
                      ),
                    ),
