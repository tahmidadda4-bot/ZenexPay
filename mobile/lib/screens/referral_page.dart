            ...
            return RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const SizedBox(height: 14),
                  const _InfoRow(icon: Icons.info_outline_rounded, text: 'A referral becomes successful after the referred account completes its first approved task. Only qualified referrals receive the wallet bonus.'),
                ],
              ),
            );
          },
