          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Add the requested details or proof information. Screenshot upload, when needed, remains available from Submissions.', style: TextStyle(color: Colors.white54, height: 1.45, fontSize: 12)),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    filled: true,
                    fillColor: Color(0xFF070D1A),
                    border: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(17)), borderSide: BorderSide.none),
                  ),
                ),
              ],
            ),
