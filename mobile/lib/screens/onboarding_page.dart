...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  void _next() {
    if (_page == _slides.length - 1) { Navigator.pop(context); return; }
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Column(children: [
            Align(alignment: Alignment.topRight, child: TextButton(onPressed: () => Navigator.pop(context), child: const Text('Skip'))),
