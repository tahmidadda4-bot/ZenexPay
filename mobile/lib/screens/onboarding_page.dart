...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: widget.isTour ? AppBar(title: const Text('App Tour')) : null,
      body: Container(
        ...
        child: SafeArea(
          ...
          child: Column(children: [
            if (!widget.isTour) Align(alignment: Alignment.topRight, child: TextButton(onPressed: _finishing ? null : _finish, child: const Text('Skip'))),
            ...
            Padding(padding: const EdgeInsets.fromLTRB(22, 0, 22, 24), child: FilledButton(onPressed: _finishing ? null : _next, child: Text(_page == _slides.length - 1 ? 'Get Started' : 'Next'))),
          ]),
        ),
      ),
    );
