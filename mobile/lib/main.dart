  ...
  ThemeData _theme(Brightness brightness) {
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: TextStyle(color: dark ? Colors.white35 : Colors.black38),
      ...
      navigationBarTheme: NavigationBarThemeData(height: 70, backgroundColor: dark ? const Color(0xFF030A19) : Colors.white, surfaceTintColor: Colors.transparent, indicatorColor: kPurple.withOpacity(.28), labelTextStyle: const WidgetStatePropertyAll(TextStyle(fontSize: 9, fontWeight: FontWeight.w900)), iconTheme: WidgetStateProperty.resolveWith((states) => IconThemeData(color: states.contains(WidgetState.selected) ? Colors.white : Colors.white54, size: 20))),
